...
const siteConfiguration: FigmaSiteConfiguration = {
  title: "Daniyal Jamil — DevOps & Cloud Engineer Portfolio",
  description: "Portfolio for DevOps and Cloud Engineers showcasing AWS, GCP, Kubernetes, Terraform, and CI/CD automation.",
}
